...
@section('content_script')
    ...
    <!-- jQuery Sparklines -->
    <script src="{{ URL::to('shantu/js/jquery.sparkline.min.js') }}"></script>
    <!-- JQVMap -->
    <script src="{{ URL::to('shantu/js/jquery.vmap.js') }}"></script>
    <script src="{{ URL::to('shantu/js/jquery.vmap.world.js') }}"></script>
    <script src="{{ URL::to('shantu/js/jquery.vmap.usa.js') }}"></script>
    <script src="{{ URL::to('shantu/js/jquery.vmap.sampledata.js') }}"></script>
    <!-- easy-pie-chart -->
    <script src="{{ URL::to('shantu/js/jquery.easypiechart.min.js') }}"></script>
