                  ...
                  <div class="row">
                    <div class="col-md-9">
                      <div class="img-container">
                        <img id="image" src="{{ URL::to('images/cropper.jpg') }}" alt="Picture">
                      </div>
                    </div>
                    <div class="col-md-3">
...
<!-- Ion.RangeSlider -->
<script src="{{ URL::to('shantu/js/ion.rangeSlider.min.js') }}"></script>
<!-- Bootstrap Colorpicker -->
<script src="{{ URL::to('shantu/js/bootstrap-colorpicker.min.js') }}"></script>
<!-- jquery.inputmask -->
<script src="{{ URL::to('shantu/js/jquery.inputmask.bundle.min.js') }}"></script>
<!-- jQuery Knob -->
<script src="{{ URL::to('shantu/js/jquery.knob.min.js') }}"></script>
<!-- Cropper -->
<script src="{{ URL::to('shantu/js/cropper.min.js') }}"></script>
