...
@endif
    ...
    <div class="form-group">
      ...
      <div class="col-md-3 col-sm-3 col-xs-3">
          ...
          <input type="tel" class="form-control has-feedback-left" id="inputSuccess2" placeholder="ชื่อสนามสอบ" name="th_explace" value="{{ isset($explaces) ? $explaces->th_explace : '' }}">
...
<div class="row">
    ...
    <div class="form-group">
      ...
      <div class="col-md-3 col-sm-3 col-xs-3">
        ...
        <input type="tel" class="form-control has-feedback-left" id="inputSuccess3" placeholder="ชื่อสนามสอบ" name="en_explace"  value="{{ isset($explaces) ? $explaces->en_explace : '' }}">
        <span class="fa fa-map-marker form-control-feedback left" aria-hidden="true"></span>
      </div>
    </div>
</div>
