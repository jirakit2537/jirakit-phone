                                                        ...
                                                        <table class="table table-hover table-bordered text-center">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="text-center"><s class="success text-center">สอบได้</s></th>
                                                                    <th class="text-center">
                                                                        <is class="danger text-center">สอบตก</is>
                                                                    </th>
                                                                    <th class="text-center"><s class="success text-center">สอบได้
                                                                            %</s></th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td class="">{{ $value->whereIn('id_level',
                                                                        [4])->sum('stit3') }}</td>
                                                                    <td class=""><s class="success text-center">{{
                                                                            $value->whereIn('id_level',
                                                                            [4])->sum('stit4') }}</s></td>
                                                                    <td class=""><s class="danger text-center">{{
                                                                            $value->whereIn('id_level',
                                                                            [4])->sum('stit5') }}</s></td>
                                                                    @if($value->whereIn('id_level', [4])->sum('stit4')
                                                                    == 0)
                                                                    <td><s class="danger">0%</s>
                                                                    </td>
                                                                    @else

                                                                    <td> <s class="success text-center"> {{
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class=""><s class="success text-center">{{
                                                                            $value->whereIn('id_level',
                                                                            [4,5,6])->sum('stit4') }}</s></td>
                                                                    <td class=""><s class="danger text-center">{{
                                                                            $value->whereIn('id_level',
                                                                            [4,5,6])->sum('stit5') }}</s></td>
                                                        ...
                                                        <table class="table table-hover table-bordered text-center">
                                                            <thead>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th class="text-center">คงเหลือ</th>
                                                                    <th class="text-center"><s class="success text-center">สอบได้</s></th>
                                                                    <th class="text-center"><s class="danger text-center">สอบตก</s></th>
                                                                    <th class="text-center"><s class="success text-center">สอบได้
                                                                            %</s></th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class=""><s class="success text-center">{{
                                                                            $value->whereIn('id_level',
                                                                            [7,8,9])->sum('stit4') }}</s></td>
                                                                    <td class=""><s class="danger text-center">{{
                                                                            $value->whereIn('id_level',
                                                                            [7,8,9])->sum('stit5') }}</s></td>
                                                                    @if($value->whereIn('id_level',
                                                                    [7,8,9])->sum('stit4') == 0)
                                                                    <td><s class="danger">0%</s>
                                                                    </td>
                                                        ...
                                                        <table class="table table-hover table-bordered text-center">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class=""><s class="success text-center">{{
                                                                            $value->whereIn('id_level',
                                                                            [4,5,6,7,8,9])->sum('stit4') }}</s></td>
                                                                    <td class=""><s class="danger text-center">{{
                                                                            $value->whereIn('id_level',
                                                                            [4,5,6,7,8,9])->sum('stit5') }}</s></td>
                                                                    @if($value->whereIn('id_level',
