            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="panel-heading">
                        ...
                        <a href="{{ route('explace2.pdf') }}" class="btn btn-success">ทำเล่ม</a>
                    </div>
                </div>
              </div>
            <div class="col-md-12 col-sm-12 col-xs-12">
...
<tbody>
  <?php $i = 0; ?>
	...
	<tr>
		<td>{{ ++$i }}</td>
		<td><a href="{{ route('explace2.show',$explaces->id) }}"> {{ $explaces->th_explace or 'ไม่พบข้อมูล' }}</a></td>
		<td>{{ $explaces->en_explace or 'ไม่พบข้อมูล' }}</td>
    <td>{{ $explaces->countrys->th_country or 'ไม่พบข้อมูล' }}</td>
    <td>{{ $explaces->countrys->en_country or 'ไม่พบข้อมูล' }}</td>
		<td>
