...
@endif
    ...
    <td>{{ $stitexams->edu_year or 'ไม่พบข้อมูล' }}</td>
      ...
      <td>
        @if(($stitexams->explace()->count()))
          ...
          ?>
          {{ $stitexams->explace->th_explace or 'ไม่พบข้อมูลสนามสอบ' }}
      ...
      @endif
       ...
       <td>{{ $stitexams->level->th_level or 'ไม่พบข้อมูล' }}</td>
		<td>
...
<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    <div class="x_title">
      ...
      <h2>สถิติข้อมูลรวม</h2>  {!! Form::selectYear('year',  2560, 2460, null  ,array('class'=>' form-control', 'id' => 'stats',  'placeholder' => '--- เลือกปีการศึกษา ---')) !!}
      ...
      <div class="row">
        ...
        <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
          <div class="tile-stats">
            ...
            <div class="count" style="color:black;"><i id="st1"> {{ $st1 or 'ไม่พบข้อมูล' }}</i></div>
        ...
        <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
          <div class="tile-stats">
            ...
            <div class="count" style="color:red;"><i id="st2"> {{ $st2 or 'ไม่พบข้อมูล' }}</i></div>
        ...
        <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
          <div class="tile-stats">
            ...
            <div class="count"><i id="st3"> {{ $st3 or 'ไม่พบข้อมูล' }}</i></div>
        ...
        <div class="animated flipInY col-lg-5 col-md-4 col-sm-6 col-xs-12">
          <div class="tile-stats">
            ...
            <div class="count" style="color:blue;"><i id="st4"> {{ $st4 or 'ไม่พบข้อมูล' }}</i></div>
        ...
        <div class="animated flipInY col-lg-5 col-md-4 col-sm-6 col-xs-12">
          <div class="tile-stats">
            ...
            <div class="count" style="color:red;"><i id="st5">   {{ $st5 or 'ไม่พบข้อมูล' }}</i></div>
