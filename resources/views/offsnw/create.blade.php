                                    ...
                                    <div class="x_content">
                                        ...
                                        <table class="table table-bordered ">
                                            ...
                                            <tr>
                                                ...
                                                <th>       {!! Form::selectYear('edu_year',  2560, 2460 , null,array('class'=>' form-control')) !!}</th>
                                            </tr>
                                            <tr>
                                                <th> บันทึก</th>
                    ...
                    (function () {
                        ...
                        $("table").on("change", "input", function () {
                            ...
                            if (total < 0) {
                                ...
                                row.find(".stit3s").val(isNaN(total) ? "" : total);
                                $('.exam3').addClass('has-success');
                                $('.exam3').removeClass('has-error');
                            }
                            if (total2 < 0) {
                                alert("จำนวนสอบได้ มากกว่าจำนวนคงสอบ กรุณาใส่ข้อมูลใหม่");
                                row.find(".stit5s").val(isNaN(total2) ? "" : total2);
                                $('.exam5').addClass('has-error');
                                $('.exam5').removeClass('has-success');
                            } else {
                                row.find(".stit5s").val(isNaN(total2) ? "" : total2);
                                $('.exam5').addClass('has-success');
                                $('.exam5').removeClass('has-error');
