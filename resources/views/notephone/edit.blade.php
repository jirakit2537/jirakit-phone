						...
						<div class="x_content">
							...
							<div class="panel panel-primary">
								...
								<div class="panel-body">
									...
									{!! Form::model($note, ['method' => 'PATCH','route' => ['notephone.update', $note->id], 'id' => 'form_id']) !!}
									<div class="row">
										...
										<div class="col-xs-12 col-sm-12 col-md-12">
											<div class="form-group">
												...
												{!! Form::text('fromnote',null,  array('placeholder' => 'ติดต่อจาก(โรงเรียน/วัด/สนาม)','class' => 'form-control')) !!}
											</div>
										</div>
										...
										<div class="col-xs-6 col-sm-6 col-md-6">
											<div class="form-group">
												...
												{!! Form::text('districts_id', null, array('placeholder' => 'ใส่ชื่อตำบล','class' => 'form-control' , 'id' => 'district')) !!}
												</select>
											</div>
										</div>
										<div class="col-xs-6 col-sm-6 col-md-6">
											<div class="form-group">
												...
												{!! Form::text('amphures_id', null, array('placeholder' => 'ใส่ชื่ออำเภอ','class' => 'form-control' , 'id' => 'amphoe')) !!}
												</select>
											</div>
										</div>
										<div class="col-xs-6 col-sm-6 col-md-6">
											<div class="form-group">
												...
												{!! Form::text('provinces_id', null, array('placeholder' => 'ใส่ชื่อจังหวัด','class' => 'form-control' , 'id' => 'province')) !!}
											</div>
										</div>
										{{--<div class="col-xs-6 col-sm-6 col-md-6">--}}
										{{--<div class="form-group">--}}
